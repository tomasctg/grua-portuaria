function [vyt,vxt,x_end,vxt_end,vyt_end,len,len2,estado_barco2] = cont_to_cont(estado_barco,posx_init,posy_init,posx_end,twistlocks,ml)
    tic
...
if (twistlocks)
    estado_barco2(posx_init_index) = estado_barco(posx_init_index) - 1;
